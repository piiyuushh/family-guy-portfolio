      ...
      <section class="text-gray-600 body-font w-full">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center mb-4">
          ...
          <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900" className="about-header">
            Description
            </h1>
            ...
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900" className="about-header">Working environment</h1>
            <p class="mb-8 leading-relaxed" className="topic">
            Windows and MacOS
            </p>
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900" className="about-header">Tech Stack</h1>
            <p class="mb-8 leading-relaxed" className="topic">
